...
int myMemcmp( const void * const buffer1, const void * const buffer2, size_t count )
{
	if ( buffer1 == buffer2 )
	{
		return 0;
	...
	{
		const char * const pBuffer1 = ( const char * const )buffer1;
		const char * const pBuffer2 = ( const char * const )buffer2;
		for ( size_t i=0; i<count; ++i )
		{
